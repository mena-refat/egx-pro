    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        ...
        <select
          ...
          className="px-3 py-2 text-sm bg-[#111118] border border-white/10/80 rounded-lg text-slate-300 focus:outline-none"
        >
      ...
      <DataTable
        headers={['Subject', 'User', 'Status', 'Priority', 'Date', '']}
        loading={loading}
        rowCount={tickets.length}
      >
        {tickets.map((t) => (
          <tr key={t.id} className="hover:bg-white/5/40 transition-colors">
      ...
      >
        {selected && (
          <div className="space-y-4">
            <div className="bg-[#0d0d14] rounded-lg p-4 border border-white/10/60">
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-3 py-2.5 text-sm bg-[#0d0d14] border border-white/10/80 rounded-lg text-white focus:outline-none focus:border-emerald-500/50 resize-none"
              />
            </div>
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 text-sm bg-[#0d0d14] border border-white/10/80 rounded-lg text-white focus:outline-none"
              >
                <option value="IN_PROGRESS">In Progress</option>
                <option value="RESOLVED">Resolved</option>
                <option value="CLOSED">Closed</option>

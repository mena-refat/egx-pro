    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0f] p-4">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <form
          ...
          className="bg-[#111118] border border-white/10/80 rounded-2xl p-6 space-y-4 shadow-2xl"
        >
          {error && (
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-9 pr-4 py-2.5 bg-[#0d0d14] border border-white/10/80 rounded-lg text-sm text-white placeholder-slate-600 focus:outline-none focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/20 transition-all"
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-9 pr-10 py-2.5 bg-[#0d0d14] border border-white/10/80 rounded-lg text-sm text-white placeholder-slate-600 focus:outline-none focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/20 transition-all"
                placeholder="••••••••••••"
              />
              <button
                type="button"

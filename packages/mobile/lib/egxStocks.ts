...
const EGX_DESCRIPTIONS: Record<string, { ar: string; en: string }> = {
  ...
  CIEB: { ar: "بنك فرنسي-مصري مشترك تابع لمجموعة كريدي أجريكول الفرنسية، يقدم خدمات مصرفية للأفراد والشركات في مصر.", en: "A French-Egyptian joint-venture bank affiliated with Crédit Agricole Group, offering retail and corporate banking in Egypt." },
  ...
  EGBE: { ar: "بنك مصري-خليجي يقدم خدمات مصرفية شاملة للأفراد والشركات، مع تركيز على تسهيل الأعمال بين مصر ودول الخليج.", en: "An Egyptian-Gulf bank offering retail and corporate banking, focused on facilitating business between Egypt and the Gulf." },
  ...
  PHDC: { ar: "شركة تطوير عقاري رائدة متخصصة في المجتمعات السكنية الفاخرة في القاهرة الجديدة وأكتوبر والساحل الشمالي.", en: "A leading real-estate developer specializing in premium integrated residential communities in New Cairo, October City and the North Coast." },
  ...
  EMFD: { ar: "شركة تطوير عقاري مصرية-إماراتية تابعة لمجموعة إعمار الإماراتية، تطور مشروعات ميفيدا ومشروعات مميزة في القاهرة الجديدة.", en: "An Egyptian-UAE real-estate developer, a subsidiary of Emaar Properties, developing Mivida and landmark projects in New Cairo." },
  ...
  HELI: { ar: "شركة متخصصة في تطوير الإسكان والمجمعات العمرانية في منطقة مصر الجديدة (هليوبوليس).", en: "A company specializing in housing and urban development in the Heliopolis district, one of Cairo's most historic areas." },
  ...
  EGAL: { ar: "الشركة الحكومية المنتجة للألومنيوم في مصر، تقع في نجع حمادي وتعتمد على الطاقة الكهرومائية في عملياتها.", en: "Egypt's state-owned aluminium producer, located in Nag Hammadi and powered by hydroelectric energy." },
  HRHO: { ar: "أكبر بنك استثماري وشركة خدمات مالية في منطقة الأسواق الناشئة بالشرق الأوسط وأفريقيا (EFG Hermes)، تقدم خدمات إدارة الأصول والوساطة والاكتتابات.", en: "The largest investment bank and financial-services firm in MENA/frontier markets (EFG Hermes), offering asset management, brokerage and capital-markets services." },
  ...
  OFH: { ar: "الذراع المالية لمجموعة أوراسكوم، تُركز على الاستثمار في الخدمات المالية في مصر والشرق الأوسط وأفريقيا.", en: "The financial arm of Orascom Group, focused on investing in financial services across Egypt, MENA and Africa." },
  EKHO: { ar: "شركة قابضة مصرية-كويتية متنوعة تستثمر في البتروكيماويات والتأمين والخدمات المالية في مصر.", en: "An Egyptian-Kuwaiti diversified holding company investing in petrochemicals, insurance and financial services in Egypt." },
  CLHO: { ar: "سلسلة مستشفيات خاصة رائدة في مصر، تضم عدة مستشفيات في القاهرة وتقدم خدمات صحية شاملة.", en: "A leading private hospital chain in Egypt comprising multiple Cairo hospitals and offering comprehensive healthcare services." },
  ...
  TALM: { ar: "شركة رائدة في إدارة المدارس الخاصة والدولية في مصر، تُشغّل مدارس ذات مناهج دولية وتخدم آلاف الطلاب.", en: "A leading operator of private and international schools in Egypt, running internationally-accredited campuses serving thousands of students." },
  ...
  OLFI: { ar: "شركة متنوعة في الصناعات الغذائية تُنتج مجموعة واسعة من منتجات الألبان والأجبان والأغذية المصنعة من مدينة العبور الصناعية.", en: "A diversified food-industry company producing dairy, cheese and processed foods from its Obour industrial base." },
  ...
  AUTO: { ar: "أكبر موزع للسيارات في مصر ومنطقة الشرق الأوسط وأفريقيا (جي بي أوتو)، يمثل علامات تجارية عالمية كهيونداي وشيري وغيرها.", en: "The largest vehicle distributor in Egypt, MENA and Africa (GB Auto), representing major global brands including Hyundai and Chery." },
  ...
  OTMT: { ar: "الشركة القابضة لمجموعة أوراسكوم للاستثمار، تمتلك محفظة متنوعة من الاستثمارات في الطاقة والإنشاء والسياحة.", en: "Orascom Investment Holding, controlling a diversified portfolio across energy, construction and tourism sectors." },

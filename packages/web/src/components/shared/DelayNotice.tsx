...
export default function DelayNotice({
  ...
  return (
    <div className="dropdown-appear mb-4 rounded-xl border border-[var(--warning)]/30 bg-[var(--warning-bg)] p-4 flex flex-col sm:flex-row sm:items-center gap-3">
      <div className="flex gap-3 flex-1 min-w-0">
        <div className="shrink-0 w-10 h-10 rounded-full bg-[var(--warning-bg)] flex items-center justify-center">

...
export const ACHIEVEMENT_DEFS: AchievementDef[] = [
  ...
  { id: 'network', level: 'growth', title: 'الشبكة', shortDescription: 'دعوة 15 صديقاً للنجاح', longDescription: 'خمس عشرة دعوة ناجحة تعني أنك تبني شبكة من المستثمرين الواعين وتحصل على شهر Pro مجاناً. النجاح يُقاس أحياناً بمن نرفع معنا.', route: '/account?tab=referral' },
  ...
  { id: 'mega-referrer', level: 'legend', title: 'الداعية الكبير', shortDescription: '50 شخصاً يثقون في رأيك', longDescription: 'خمسون شخصاً انضموا بفضلك يعني ثقة كبيرة في توصيتك. أنت داعية الاستثمار الواعي.', route: '/account?tab=referral' },
  { id: 'referral-legend', level: 'legend', title: 'أسطورة الدعوات', shortDescription: '100 شخص انضموا بفضلك', longDescription: 'مئة شخص انضموا بفضلك يضعك بين أساطير الدعوة. التأثير الحقيقي يُقاس بالأعداد.', route: '/account?tab=referral' },
  { id: 'community-leader', level: 'legend', title: 'قائد المجتمع', shortDescription: '500 شخص في مجتمعك', longDescription: 'خمسمائة شخص في مجتمعك يعني أنك قائد حقيقي. المجتمع يبنيه من يرفع الآخرين.', route: '/account?tab=referral' },
  { id: 'the-1000', level: 'legend', title: 'الـ 1000', shortDescription: 'ألف شخص — أنت ظاهرة', longDescription: 'ألف شخص انضموا بفضلك يعني أنك ظاهرة نادرة. هذا المستوى للقلة فقط.', route: '/account?tab=referral' },

...
export const ACHIEVEMENT_DEFS: AchievementDef[] = [
  ...
  { id: 'network', level: 'growth', title: 'الشبكة', shortDescription: 'دعوة 5 أصدقاء للنجاح', longDescription: 'خمس دعوات ناجحة تعني أنك تبني شبكة من المستثمرين الواعين. النجاح يُقاس أحياناً بمن نرفع معنا.', route: '/account?tab=referral' },
